              ...
              return (
                ...
                >
                  ...
                  <div className="mb-3 grid grid-cols-2 gap-2 rounded-lg border border-border/40 bg-theme/5 p-2">
                    <div>
                      <div className="text-[10px] uppercase tracking-wide text-primary/55">Status / Type</div>
                      <div className="text-sm font-semibold">
                        {trade.orderStatus} / {trade.orderType}
                      </div>
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 gap-x-4 gap-y-2 text-xs sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div>
                      <div className="text-[11px] uppercase tracking-wide text-primary/60">Type</div>
                    ...
                    <div>
                      <div className="text-[11px] uppercase tracking-wide text-primary/60">Tx Hash</div>
                      <div className="font-medium">
                        {!trade.tx_hash ||
                        trade.orderStatus === "CANCELLED" ||
                        trade.orderStatus === "PENDING" ? (
